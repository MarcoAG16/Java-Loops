...
public class DoWhileLoop {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 * Do-While. Do-While. Evalúa su expresión en la parte inferior del ciclo. POr lo tanto, las declaraciones dentro del bloque "do" siempre se ejecutan al menos una vez
		 * 
		 * 
		 * */
		 ...
		 */
		System.out.println("Bienvenido al BancoGen, elige cualquiera de las opciones, para ello escribe el número que corresponda:");
